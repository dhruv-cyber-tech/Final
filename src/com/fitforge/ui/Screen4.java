...
public class Screen4 extends JPanel {
    ...
    public Screen4(Image bgImage, CardLayout card, JPanel mainPanel) {
        ...
        // --- UPDATED LAYOUT ---
        add(createLabel("Training History", 26, true, Color.WHITE, JLabel.CENTER, 20, 420, 320, 30));

        String bodyText = "<html><center>See your previous workouts<br>and be proud of your progress.</center></html>";
        ...
        RoundButtonCanvas next4 = new RoundButtonCanvas(nextIcon);

        Color orangeColor = new Color(243, 180, 48); // The orange/yellow
        Color pressedOrange = new Color(220, 160, 40); // A darker shade
        next4.setButtonColors(orangeColor, pressedOrange);

        next4.setBounds(150, 570, 60, 60); // Adjusted Y position
