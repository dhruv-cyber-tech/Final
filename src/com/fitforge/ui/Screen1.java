...
public class Screen1 extends JPanel {
    ...
    public Screen1(Image bgImage, CardLayout card, JPanel mainPanel) {
        ...
        add(createLabel("Welcome to FitForge", 26, true, Color.WHITE, JLabel.CENTER, 20, 420, 320, 30));
        String bodyText = "<html><center>My name is ChikiBot and I will<br>be your guide on this journey.<br>Shall we start ?</center></html>";
        ...
        RoundButtonCanvas next1 = new RoundButtonCanvas(nextIcon);

        Color orangeColor = new Color(243, 180, 48); // The orange/yellow
        Color pressedOrange = new Color(220, 160, 40); // A darker shade
        next1.setButtonColors(orangeColor, pressedOrange);
        next1.setBounds(150, 570, 60, 60);
